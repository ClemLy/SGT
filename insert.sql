...
('Tester une fonctionnalité', 'Effectuer des tests QA sur la nouvelle feature', 'Terminée', '2024-11-15', 1, 1),
...
('Organiser une formation', 'Planifier et animer une session de formation', 'Terminée', '2024-11-10', 9, 8),
('Concevoir une campagne publicitaire', 'Lancer une campagne promotionnelle sur les réseaux sociaux', 'En cours', '2024-12-25', 2, 2),
('Corriger un bug', 'Résoudre un problème critique sur le module utilisateur', 'Terminée', '2024-11-18', 1, 1),
...
('Créer un formulaire en ligne', 'Développer un formulaire interactif pour le site web', 'Terminée', '2024-11-22', 5, 5),
...
('Optimiser un algorithme', 'Améliorer les performances de l’algorithme de recherche', 'Terminée', '2024-11-25', 1, 1),
...
('Créer un outil interne', 'Développer un outil pour automatiser les tâches répétitives', 'Terminée', '2024-11-22', 1, 1),
...
('Intégrer une API tierce', 'Ajouter une API pour la gestion des paiements', 'Terminée', '2024-11-20', 1, 1),
